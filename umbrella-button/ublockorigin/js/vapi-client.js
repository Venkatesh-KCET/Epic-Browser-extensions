...
vAPI.messaging = {
    ...
    createPort: async function () {
        ...
        try {
            //wait
            this.port = browser.runtime.connect(window.ublockorigin, {name: vAPI.sessionId}) || null;
        } catch (ex) {
            this.port = null;
        }
    ...
    getPort: async function () {
        return this.port !== null ? this.port : await this.createPort();
    },
